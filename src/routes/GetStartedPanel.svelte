...
<section class="flex flex-col space-y-4">
    <div class="-m-4 px-8 pt-14 bg-slate-800 text-white">
        <div
            class="text-white py-14 tailerslarge trailers-text uppercase text-center"
        >
        ...
        <p class="text-center text-2xl">
            <span class="text-lime-400">{APP_NAME}</span> lets you monitor and manage
            Redis Cloud, Redis OSS or Redis Enterprise.
        </p>
        <div class="flex justify-center space-x-8 p-12 text-xl">
            <a href="/console" class="lime-button">
                <span class="px-4"> Start Building </span>
            </a>
            <a href="/how-it-works" class="no-outline-button text-white">
    ...
    <div
        class="-mx-4 pb-12 justify-center bg-slate-800 text-black flex space-x-12 items-center"
    >
    ...
    <div class="flex flex-col space-y-4 items-center justify-center p-8">
        <h1 class="text-5xl">Why Redis OneCloud</h1>
        <p class="text-xl">
            Manage all redis instances across OSS and all cloud providers
        </p>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 pt-8">
        ...
        >
            ...
            >
                ...
                <p class="grow">
                    Already running? Activate your Redis instance with an
                    activation code OR add an existing server
                </p>
...
<AddDatabase
    bind:open={addDatabaseModalOpen}
    on:close={() => goto("/console")}
/>
